...
This baseline is deliberately small — the diff-visible, tooling-uncovered, high-precision subset of the catalog. Smells are judgment calls, never blockers — label each "possible <smell>".
