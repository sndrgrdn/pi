...
- Headline and first move, then ask before dumping the rest. One-line TL;DR on top if it must be long. End with a clear next action only when one is needed.
